...
gt elitists love to think they have some sort of phd, but spontaneously combust when they have to piece together a mechanical mixer.""",
        "^gurasic": """go have a skill issue somwere else just cuz a 2015 laptop takes 500ms-1 second to load insted of instantly

"but.... but the nested for loops..."
grow up,, i aint nasa optimizing every single bit, fuck yoy
litteraly, least toxic programer on their way to shit on a developer with little to no experience (they have to tach them)""",
        ...
        """I'd just like to interject for a moment. What you're refering to as "GregTech" is in fact, "GregTech: New Horizons", or as I've recently taken to calling it, "GregTech + New Horizons". GregTech is not a full modpack unto itself, but rather an essential component of a fully functioning GregTech New Horizons modpack, made useful by a variety of other mods, such as Applied Energistics, Galacticraft, GT++ and SGCraft.

Many players run modpacks based on GregTech, which are not GregTech: New Horizons. Through a peculiar turn of events, the name "GregTech" started to refer to "GregTech: New Horizons", even though many other GregTech based modpacks exist, and are popular, such as "Nomifactory", "GregTech Community Pack", "FTB: Interactions", "InfiTech2" and "Supersymmetry".

There really is a GregTech, and these players are using it, but it is just a part of the modpack they use. GregTech is the main mod: the overarching idea and style, into which all other mods are integrated. GregTech is an essential part of a GregTech-based modpack, but can also be played by itself; it can function independently, though it isn't as fun. GregTech is normally played as a part of a modpack such as GregTech: New Horizons; the pack is basically GregTech with various additions, such as Applied Energistics or the SGCraft mod, and the whole can be called "GregTech + New Horizons". So the so called "GregTech" doesn't have to be "GregTech: New Horizons", there are many other modpacks which are based on GregTech."""
		),
        "^gtchina": "GregoriusT系格雷科技系列模组的作者。他同时也是IndustrialCraft 2 Dev Team的成员，受邀代替RichardG867修复各种漏洞，然而不久后便不再参与开发。他制作的所有模组均在IC2论坛发布。他因基本没有社交网络或论坛的账户而出名，目前可以知道他拥有IC2论坛",
        "^essential": "xD imagine being so stupid that you dont even use your singular braincell to ask why, we already have a mod that adds free hosting, so kindly go fuck yourself",
        ...
        "^skibidi": """My son is too scared of the "Skibidi Toilet" to start potty training
...
My son is three years old, and we've been trying to potty train him for a while now. Unfortunately, we've hit a major roadblock - his fear of the "skibidi toilet" You might be wondering what a "skibidi toilet" is, and honestly, I had no idea either until we encountered it. Fron what I've gathered, "skibidi toilet" is basically a new genre of youtube video about evil singing toilets. Basically think zombies but instead they're toilets that sing in your face. I was fine to let my son watch the videos at first, as they seemed innocent enough and fairly harmless, but they soon devolved into strange post apocalyptic material with grotesque toilets fighting in a war against mankind, so I finally intervened and cut him off. I thought that was the end of it, he can't watch the videos anymore so theres nothing to be afraid of. Well, I was wrong. This has since turned into a complete nightmare for us at home. We recently started potty training and he refuses to use the toilet now due to skibidi toilet. Whenever we try to put him on it he screams and refuses to go anywhere near it. We've tried explaining that skibidi toilet isnt real and our toilet is completely safe, but it seems like it's too overwhelming for him. We even let him decorate it with stickers, hoping it would make him less afraid, but no luck so far. It utterly breaks my heart to see him so anxious about such a simple thing that every child goes through. I'm not sure how to proceed from here. Should we give him more time and hope that he warms to the toilet, or is it better to try a completely different approach? I know every child is different, but has anyone else experienced something similar? How did you deal with skibidi toilet in your household, if you encountered it""",
		"^gyatt": """What to do about middle school students shouting "GYAT!!!!" at me?

What would be a good way to shut this down? I don't want to give them harsh consequences, but I do want this to stop.

This happens to me daily from many different male and female students. I am an athletic man who lifts weights and has noticable muscles in my legs. Every day when I walk around campus I can hear students giggling and screaming this.

I know that you middler schoolers are pretty feral at this age so I am unsure if there is anything I can do.
...
And so, I turn to Reddit. What can I do? I realize im a bit of a mess, and most of this post is probably unhelpful, but it's kinda a messy problem to begin with. If you've got any sort of advice then go for it. A specific modpack to try, a different approach I should take, anything. Heck, I'd even take a "these are the people you should be bugging with this nonsense" at this point, it would at least tell me who to bug. Anything would help. Thanks for taking the time to read all this, at least (or not, I'm smart enough to tl;dr myself).""",
        "^model": "hey, love the model and texture, however the wings absolutely kill it for me, i just can't stand when wings are like that.... they're supposed to be like an arm and a hand, that's how they fold up and stuff! so it doesn't make any sense to just have some lines coming out from the body, those should be the fingers of the hand. if it's like this the wing won't be able to fold or articulate like it should.",
