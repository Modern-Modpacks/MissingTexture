...
async def gettz(interaction:interactions.Interaction, user:discord.User=None): # Get timezone
    ...
    if not timezone or not timezone[0]: # If the timezone is not set, notify the user
